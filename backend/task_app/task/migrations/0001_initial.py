# Generated by Django 2.1.1 on 2018-10-18 22:14
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.IntegerField(choices=[(0, 'TODO'), (1, 'IN PROGRESS'), (2, 'IN REPOSITORY'), (3, 'TEST'), (4, 'DONE')], default=0)),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='project.TaskProject')),
            ],
            options={
                'abstract': False,
            },
